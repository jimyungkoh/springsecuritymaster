...
public class JWTTokenGeneratorFilter extends OncePerRequestFilter {
    ...
    public void doFilterInternal(@NotNull HttpServletRequest request,
        ...
        if (null != authentication) {
            SecretKey key = SecretKeyProvider.getSecretKey();
            String jwt = getJwtToken(authentication, key);
    ...
    private String getJwtToken(Authentication authentication, SecretKey key) {
        String jwt = Jwts.builder().setIssuer("Jimyung Koh")
